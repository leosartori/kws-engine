...
from support_functions import create_dataset, rnn_model, debug_classifier_model, StepDecay, split_dataset_from_list, rnn_autoencoder_model
...
def main(argv):
    ...
    # traina autoencoder
        ...
        # autoenc = rnn_autoencoder_model(NUM_FEATURES, NUM_UNITS)
